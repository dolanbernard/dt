...
| chrono  | Starts a stopwatch that will begin counting on spacebar press                       | chronograph, stopwatch, stpwtch | -p/--pause-on-lap (optional) pause the stopwatch in between laps until a second press of the spacebar<br> -a/--force-ascii-timer (optional) force the use of ASCII characters for lap timer                                                                                                                                                                                                                                                                                                                    |
...
#### Run chrono with pause between laps
